...
namespace Microsoft.Xna.Framework
{
    internal class OrientationListener : OrientationEventListener
    {
        ...
        public OrientationListener(AndroidGameActivity activity)
            : base(activity, SensorDelay.Ui) { this.activity = activity; }
        ...
        public override void OnOrientationChanged(int orientation)
        {
            ...
            if (!inprogress)
            {
                ...
                var ort = (90 * (int)Math.Round(orientation / 90f)) % 360;
                ...
                {
                    case 90:
                        disporientation = DisplayOrientation.LandscapeRight;
                        break;
                    case 270:
                    ...
                    case 0:
                        ...
                        break;
                    case 180:
                        disporientation = DisplayOrientation.PortraitUpsideDown;
                        break;
                    default:
                        disporientation = DisplayOrientation.LandscapeLeft;
                        break;
