...
namespace Microsoft.Xna.Framework.GamerServices
{
    public class SignedInGamer : Gamer
    {
        ...
        private void AuthenticationCompletedCallback(IAsyncResult result) { EndAuthentication(result); }
        ...
        public IAsyncResult BeginAwardAchievement(string achievementId, AsyncCallback callback, Object state) { return BeginAwardAchievement(achievementId, 100.0, callback, state); }
        ...
        private void AwardAchievementCompletedCallback(IAsyncResult result) { EndAwardAchievement(result); }

        public void AwardAchievement(string achievementId) { AwardAchievement(achievementId, 100.0f); }
        ...
        public void UpdateScore(string aCategory, long aScore) { if (IsSignedInToLive) {} }

        public void ResetAchievements() { if (IsSignedInToLive) {} }
        ...
        public GameDefaults GameDefaults { get { throw new NotSupportedException(); } }

        public bool IsGuest { get { throw new NotSupportedException(); } }

        public bool IsSignedInToLive { get { return isSignedInToLive; } internal set { isSignedInToLive = value; } }

        public int PartySize { get { throw new NotSupportedException(); } set { throw new NotSupportedException(); } }

        public PlayerIndex PlayerIndex { get { return PlayerIndex.One; } }

        public GamerPresence Presence { get { throw new NotSupportedException(); } }

        private readonly GamerPrivileges _privileges = new GamerPrivileges();
        public GamerPrivileges Privileges { get { return _privileges; } }
