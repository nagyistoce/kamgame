namespace Microsoft.Xna.Framework.Net
{
    internal class CommandGamerJoined : ICommand
    {
        ...
        public CommandGamerJoined(long uniqueIndentifier) { remoteUniqueIdentifier = uniqueIndentifier; }

        public string DisplayName { get { return displayName; } set { displayName = value; } }

        public string GamerTag { get { return gamerTag; } set { gamerTag = value; } }

        public GamerStates State { get { return states; } set { states = value; } }

        public int InternalIndex { get { return gamerInternalIndex; } }

        public CommandEventType Command { get { return CommandEventType.GamerJoined; } }
    }
}