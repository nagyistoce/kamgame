...
namespace Microsoft.Xna.Framework.Net
{
    public enum NetworkSessionType
    {
        ...
        SystemLink,
        // Connect multiple Xbox 360 consoles or computers over a local subnet. These machines do not require a connection to Xbox LIVE or any LIVE accounts. However, connection to machines on different subnets is not allowed.
