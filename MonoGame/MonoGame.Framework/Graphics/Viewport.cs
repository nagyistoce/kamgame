...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    public struct Viewport
    {
        ...
        public float MinDepth { get { return minDepth; } set { minDepth = value; } }
        ...
        public Rectangle TitleSafeArea { get { return new Rectangle(x, y, width, height); } }
        ...
        public override string ToString() { return string.Format("[Viewport: X={0} Y={1} Width={2} Height={3}]", X, Y, Width, Height); }
    }
}