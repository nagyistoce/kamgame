...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    // the Buffer until SetData() and recreate them if set more than once.
        ...
        {
            SetDataInternal(0, data, startIndex, elementCount, SetDataOptions.Discard);
        }
        ...
        {
            SetDataInternal(0, data, 0, data.Length, SetDataOptions.Discard);
        }
            ...
            Threading.BlockOnUIThread(() =>
                {
                    ...
                    GL.BufferSubData(BufferTarget.ElementArrayBuffer, (IntPtr) offsetInBytes, (IntPtr) sizeInBytes,
                                     dataPtr);
                    GraphicsExtensions.CheckGLError();
