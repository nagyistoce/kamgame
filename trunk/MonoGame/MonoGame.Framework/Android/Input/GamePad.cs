...
namespace Microsoft.Xna.Framework.Input
{
    public class GamePad
    {
        ...
        private readonly List<ButtonDefinition> _buttonsDefinitions;
        private ThumbStickDefinition _leftThumbDefinition, _rightThumbDefinition;
        private readonly Color _alphaColor = Color.DarkGray;
        ...
        internal void SetBack() { _buttons |= (int)Buttons.Back; }

        internal void Update(MotionEvent e)
        {
            var location = new Vector2(e.GetX(), e.GetY());
            // Check where is the touch
            var hitInButton = false;
            ...
            if (e.Action == MotionEventActions.Down)
            {
                ...
                if (Visible)
                {
                    ...
                    if (!hitInButton)
                    {
                        ...
                        else if (Visible && (_rightThumbDefinition != null) &&
            ...
            else if (e.Action == MotionEventActions.Move)
            {
                ...
                if (!hitInButton)
                {
                    ...
                    {
                        var movement = location - LeftThumbStickDefinition.InitialHit;

                        // Keep the stick in the "hole" 
                        var radius = (movement.X * movement.X) + (movement.Y * movement.Y);
                    ...
                    else
                    {
                        ...
                        if (Visible && (_rightThumbDefinition != null) &&
                            (CheckThumbStickHit(_rightThumbDefinition, location)))
                        {
                            var movement = location - _rightThumbDefinition.InitialHit;
        ...
        {
            var buttonRect = new Rectangle((int)theButton.Position.X, (int)theButton.Position.Y,
        ...
        private bool CheckThumbStickHit(ThumbStickDefinition theStick, Vector2 location)
        {
            ...
            var thumbRect = new Rectangle((int)stickPosition.X, (int)stickPosition.Y, theStick.TextureRect.Width,
                theStick.TextureRect.Height);
        ...
        {
            var hitInButton = CheckButtonHit(button, location);
        ...
        public static GamePadState GetState(PlayerIndex playerIndex)
        {
            ...
            var state = new GamePadState(new GamePadThumbSticks(), new GamePadTriggers(),
                new GamePadButtons((Buttons)instance._buttons), new GamePadDPad());
            instance.Reset();
            return state;
        }
        ...
        public static bool SetVibration(PlayerIndex playerIndex, float leftMotor, float rightMotor)
        {
            try
            {
                var vibrator = (Vibrator)Game.Activity.GetSystemService(Context.VibratorService);
        ...
        public static ThumbStickDefinition LeftThumbStickDefinition { get { return Instance._leftThumbDefinition; } set { Instance._leftThumbDefinition = value; } }

        public static ThumbStickDefinition RightThumbStickDefinition { get { return Instance._rightThumbDefinition; } set { Instance._rightThumbDefinition = value; } }


        #region render virtual gamepad

        public static List<ButtonDefinition> ButtonsDefinitions { get { return Instance._buttonsDefinitions; } }

        public static void Draw(GameTime gameTime, SpriteBatch batch) { Instance.Render(gameTime, batch); }
