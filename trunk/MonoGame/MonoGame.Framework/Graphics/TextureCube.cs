...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    //TODO
#else
        private readonly PixelInternalFormat glInternalFormat;
        private readonly PixelFormat glFormat;
        private readonly PixelType glType;
#endif
    ...
    //TODO
        ...
        public void SetData<T>(CubeMapFace face, T[] data) where T : struct { SetData(face, 0, null, data, 0, data.Length); }

        public void SetData<T>(CubeMapFace face, T[] data,
            int startIndex, int elementCount) where T : struct { SetData(face, 0, null, data, startIndex, elementCount); }
            ...
            T[] data, int startIndex, int elementCount) where T : struct
        {
            ...
            var xOffset = 0;
            var yOffset = 0;
            var width = Math.Max(1, size >> level);
            var height = Math.Max(1, size >> level);
