...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    public struct VertexElementColor
    {
        ...
        public override string ToString() { return string.Format("[Color: R={0}, G={1}, B={2}, A={3}]", R, G, B, A); }
        ...
        public static implicit operator VertexElementColor(Color typ)
        {
            ...
            var c = new VertexElementColor(typ);
            return c;
        }

        public static bool operator ==(VertexElementColor left, Color right) { return (left.R == right.R && left.G == right.G && left.B == right.B && left.A == right.A); }

        public static bool operator !=(VertexElementColor left, Color right) { return !(left == right); }
        ...
        public override int GetHashCode() { return (int)PackedValue; }
