...
namespace Microsoft.Xna.Framework.Graphics.PackedVector
{
    public struct Short2 : IPackedVector<uint>, IEquatable<Short2>
    {
        ...
        public static bool operator !=(Short2 a, Short2 b) { return !a.Equals(b); }
        ...
        void IPackedVector.PackFromVector4(Vector4 vector) { _short2Packed = PackInTwo(vector.X, vector.Y); }
