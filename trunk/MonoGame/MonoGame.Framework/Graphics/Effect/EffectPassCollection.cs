...
namespace Microsoft.Xna.Framework.Graphics
{
    public class EffectPassCollection : IEnumerable<EffectPass>
    {
        ...
        public int Count { get { return _passes.Count; } }

        public List<EffectPass>.Enumerator GetEnumerator() { return _passes.GetEnumerator(); }

        IEnumerator<EffectPass> IEnumerable<EffectPass>.GetEnumerator() { return _passes.GetEnumerator(); }

        IEnumerator IEnumerable.GetEnumerator() { return _passes.GetEnumerator(); }

        internal void Add(EffectPass pass) { _passes.Add(pass); }
    }
}