...
namespace Microsoft.Xna.Framework.Graphics
{
    public class Effect : GraphicsResource
    {
            ...
            : this(graphicsDevice)
        {
            ...
            //
            var effectKey = Hash.ComputeHash(effectCode);
            Effect cloneSource;
        ...
        protected internal virtual bool OnApply() { return false; }
                ...
                if (elements.Count == 0 && structMembers.Count == 0)
                {
                    switch (type)
                    {
                        ...
                        case EffectParameterType.Int32:
                        {
                            ...
                            for (var j = 0; j < buffer.Length; j++) buffer[j] = reader.ReadInt32();
                            data = buffer;
                            break;
                        }
                        case EffectParameterType.Single:
                        {
                            ...
                            for (var j = 0; j < buffer.Length; j++) buffer[j] = reader.ReadSingle();
                            data = buffer;
                            break;
                        }
