...
namespace Microsoft.Xna.Framework.Storage
{
    ...
    public class StorageContainer : IDisposable
    {
        ...
        public StorageDevice StorageDevice { get { return _device; } }
        ...
        //     are supported.
        public string[] GetDirectoryNames(string searchPattern) { throw new NotImplementedException(); }
        //
        // Summary:
        ...
        public Stream OpenFile(string file, FileMode fileMode) { return OpenFile(file, fileMode, FileAccess.ReadWrite, FileShare.ReadWrite); }
        //
        // Summary:
        ...
        public Stream OpenFile(string file, FileMode fileMode, FileAccess fileAccess) { return OpenFile(file, fileMode, fileAccess, FileShare.ReadWrite); }
        //
        // Summary:
        //     Opens a file in the StorageContainer in the designated mode with the specified
