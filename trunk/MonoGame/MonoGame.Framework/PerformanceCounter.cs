...
namespace Microsoft.Xna.Framework
{
    internal class PerformanceItem
    {
        ...
        {
            return string.Format("[{0}({1}%)\t HitCount={2}\t TotalTime={3}ms\t MaxTime={4}ms\t AverageTime={5}ms]",
                Name, (100 * TotalTime) / PerformanceCounter.ElapsedTime, HitCount, TotalTime, MaxTime,
                TotalTime / HitCount);
        }
    ...
    {
        private static readonly Dictionary<string, PerformanceItem> _list = new Dictionary<string, PerformanceItem>();
        ...
        public static void Begin() { _startTime = DateTime.Now.Ticks; }

        public static long ElapsedTime { get { return _endTime - _startTime; } }
        ...
        public static void BeginMensure(string Name)
        {
            ...
            else
            {
                ...
                item.Name = "ID: " + Name + " In " + methodBase.ReflectedType + "::" + methodBase.Name;
#else
                item.Name = "ID: " + Name;
#endif
                item.PreviousTime = DateTime.Now.Ticks;
