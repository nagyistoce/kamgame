...
namespace Microsoft.Xna.Framework.Net
{
    public class NetworkGamer : Gamer, INotifyPropertyChanged
    {
        ...
        //bool isLocal;
        //bool hasVoice;
        private long remoteUniqueIdentifier = -1;
        private GamerStates gamerState;
        private readonly GamerStates oldGamerState;
        ...
        internal long RemoteUniqueIdentifier { get { return remoteUniqueIdentifier; } set { remoteUniqueIdentifier = value; } }

        public bool HasLeftSession { get { return false; } }

        public bool HasVoice { get { return (gamerState & GamerStates.HasVoice) != 0; } }

        public byte Id { get { return id; } }

        public bool IsGuest { get { return (gamerState & GamerStates.Guest) != 0; } }

        public bool IsHost { get { return (gamerState & GamerStates.Host) != 0; } }

        public bool IsLocal { get { return (gamerState & GamerStates.Local) != 0; } }

        public bool IsMutedByLocalUser { get { return true; } }

        public bool IsPrivateSlot { get { return false; } }

        public bool IsReady
        {
            get { return (gamerState & GamerStates.Ready) != 0; }
            set
            {
        ...
        public TimeSpan RoundtripTime { get { return TimeSpan.MinValue; } }

        public NetworkSession Session { get { return session; } }

        internal GamerStates State { get { return gamerState; } set { gamerState = value; } }

        internal GamerStates OldState { get { return oldGamerState; } }
