...
namespace Microsoft.Xna.Framework.Audio
{
    internal class XactClip
    {
        ...
        private class EventPlayWave : ClipEvent
        {
            ...
            public override void Stop() { wave.Stop(); }
            public override void Pause() { wave.Pause(); }
            public override bool Playing { get { return wave.State == SoundState.Playing; } }
            public override float Volume { get { return wave.Volume; } set { wave.Volume = value; } }
        }


        private readonly ClipEvent[] events;
        ...
        public XactClip(SoundBank soundBank, BinaryReader clipReader, uint clipOffset)
        {
            ...
            for (var i = 0; i < numEvents; i++)
            {
                ...
                {
                    case 1:
                        var evnt = new EventPlayWave();


                        clipReader.ReadUInt32(); //unkn
                        uint trackIndex = clipReader.ReadUInt16();
                        var waveBankIndex = clipReader.ReadByte();
        ...
        public void Stop() { events[0].Stop(); }

        public void Pause() { events[0].Pause(); }

        public bool Playing { get { return events[0].Playing; } }
