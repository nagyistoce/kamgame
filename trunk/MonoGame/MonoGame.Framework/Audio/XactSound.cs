...
namespace Microsoft.Xna.Framework.Audio
{
    ...
    {
        private readonly bool complexSound;
        private readonly XactClip[] soundClips;
        private readonly SoundEffectInstance wave;
        ...
        public XactSound(SoundBank soundBank, BinaryReader soundReader, uint soundOffset)
        {
            ...
            else
            {
                ...
                var waveBankIndex = soundReader.ReadByte();
            ...
            if (complexSound)
            {
                ...
                {
                    soundReader.ReadByte(); //unkn
                    var clipOffset = soundReader.ReadUInt32();
