...
namespace Microsoft.Xna.Framework.Audio
{
    public struct AudioCategory : IEquatable<AudioCategory>
    {
        ...
        internal AudioCategory(AudioEngine audioengine, string name, BinaryReader reader)
        {
            ...
            var vol = reader.ReadByte(); //volume in unknown format
            ...
            var visibilityFlags = reader.ReadByte();
        ...
        public bool Equals(AudioCategory other) { throw new NotImplementedException(); }
    }
}